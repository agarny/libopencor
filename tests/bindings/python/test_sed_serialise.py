...
"""
    ...
    simulation.ode_solver = loc.SolverForwardEuler()
...
def test_cvode_solver_with_diagonal_linear_solver():
    ...
    solver.linear_solver = loc.SolverCvode.LinearSolver.Diagonal
...
def test_cvode_solver_with_bicgstab_linear_solver():
    ...
    solver.linear_solver = loc.SolverCvode.LinearSolver.Bicgstab
...
def test_cvode_solver_with_tfqmr_linear_solver():
    ...
    solver.linear_solver = loc.SolverCvode.LinearSolver.Tfqmr
...
"""
    ...
    file = loc.File(utils.resource_path("api/sed/simulations.sedml"))
    document = loc.SedDocument(file)
